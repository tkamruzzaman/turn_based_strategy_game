...
public class GridSystemHex<TGridObject>
{
    ...
    public Vector3 GetWorldPosition(GridPosition gridPosition)
    {
        return new Vector3(gridPosition.x, 0, 0) * cellSize +
         ...
         ((gridPosition.z % 2) == 1 ? new Vector3(1, 0, 0) * cellSize * HEX_ODD_ROW_HORIZOLTAL_OFFSET_MULTIPLIER : Vector3.zero);
    }

    public GridPosition GetGridPosition(Vector3 worldPosition)
    {
        GridPosition approximateGridPosition = new(Mathf.RoundToInt(worldPosition.x / cellSize),
